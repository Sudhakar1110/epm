...
def has_permission(doc, user):
    ...
    if isinstance(doc, str):
        vals = frappe.db.get_value("Team Member Mapping", doc, ["team", "user"], as_dict=True)
        doc_team = vals.team if vals else None
        doc_user = vals.user if vals else None
