...
from frappe.utils import getdate, nowdate, cint, flt, get_first_day, get_last_day, date_diff, add_days
...
def has_permission(doc, user):
    ...
    if isinstance(doc, str):
        employee = frappe.db.get_value("Performance Scorecard", doc, "employee")
