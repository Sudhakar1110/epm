...
frappe.query_reports['Monthly Performance Report']={
    filters:[
        ...
        {fieldname:'grade',fieldtype:'Select',label:__('Grade'),options:'\nExcellent\nVery Good\nGood\nAverage\nNeeds Improvement'}
    ],
    onload:function(r){epms_fmt({'completion %':epms_progress,'overall score':epms_score,'grade':epms_badge,'status':epms_badge});}
};
